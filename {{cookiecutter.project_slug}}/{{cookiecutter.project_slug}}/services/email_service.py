...
class EmailService:
    ...
    __from_address = '{{cookiecutter.contact_name}} <{{cookiecutter.contact_email}}>'
    ...
    def send_welcome_email(cls, email):
        ...
        EmailService.send_email(email, 'Welcome to {{cookiecutter.project_name}}', html_body)
    ...
    def send_password_reset_email(cls, email, reset_id):
        ...
        EmailService.send_email(email, 'Reset your password at {{cookiecutter.project_name}}', html_body)

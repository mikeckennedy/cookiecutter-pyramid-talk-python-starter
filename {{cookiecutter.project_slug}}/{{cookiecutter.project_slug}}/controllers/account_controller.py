...
from {{cookiecutter.project_slug}}.viewmodels.forgotpassword_viewmodel import ForgotPasswordViewModel
from {{cookiecutter.project_slug}}.viewmodels.register_viewmodel import RegisterViewModel
from {{cookiecutter.project_slug}}.viewmodels.resetpassword_viewmodel import ResetPasswordViewModel
from {{cookiecutter.project_slug}}.viewmodels.signin_viewmodel import SigninViewModel
...
class AccountController(BaseController):
    ...
    def signin_post(self):
        vm = SigninViewModel()
        vm.from_dict(self.merged_dicts)

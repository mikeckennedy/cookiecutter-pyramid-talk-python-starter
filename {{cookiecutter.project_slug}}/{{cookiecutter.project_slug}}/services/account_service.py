...
from {{cookiecutter.project_slug}}.data.account import Account
from {{cookiecutter.project_slug}}.data.dbsession import DbSessionFactory
from {{cookiecutter.project_slug}}.data.passwordreset import PasswordReset
...
class AccountService:
    ...
    def hash_text(plain_text_password):
        hashed_text = sha512_crypt.encrypt(plain_text_password, rounds=200000)
        return hashed_text
